    ...
    <div>
      {loading ? (
        ...
        reservations.map((item) => (
          <div
            className="bg-gray-300  rounded-xl px-5 mx-auto py-5 my-5 flex justify-between items-center w-[50%]"
            key={item._id}
          >
            {item.massageShop ? (
              <>
                <div>
                  ...
                  <button
                      ...
                      className="bg-green-600 text-white px-3 py-1 rounded-xl mr-3 
